...
![img](https://raw.githubusercontent.com/spacedustz/Obsidian-Image-Server/main/img/instancefamily.png)
...
-   t4g.large (network = 5GB, EBS) : **0.0832$ (사용 X)**
...
## rg6 기능 (Graviton2 Processor, 메모리 최적화 인스턴스)
...
## mg6 기능 (Graviton 2 프로세서, 범용 인스턴스)
...
## Graviton 1 vs Graviton 2 Processor

![img](https://raw.githubusercontent.com/spacedustz/Obsidian-Image-Server/main/img/Graviton.png)