...
**클러스터의 Root로 만들 노드에서 Erlang Cookie 파일의 위치를 찾습니다**

파일의 위치를 찾고 파일로 들어가서 쿠키 값을 복사해둡니다.

```bash
rabbitmq-diagnostics erlang_cookie_sources
```

![img](https://raw.githubusercontent.com/spacedustz/Obsidian-Image-Server/main/img2/erlang-source.png)

<br>

**클러스터의 Root의 Hashing된 쿠키 값을 확인합니다 (확인ㅁ**

```bash
rabbitmqctl list_connections
```

![img](https://raw.githubusercontent.com/spacedustz/Obsidian-Image-Server/main/img2/erlang-cookie.png)
