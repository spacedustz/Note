...
echo ----- Yum Update 종료 ---- | tee setting_logs

# HTTPS 관련 패키지 & 유틸 패키지 설치
dnf install -y firewalld net-tools curl wget gnupg lsb-release ca-certificates apt-transport-https software-properties-common gnupg-agent openjdk-17-jdk
...
docker run -d --name rabbitmq1 -p 5672:5672 -p 15672:15672 rabbitmq:3-management 
docker run -d --name rabbitmq2 -p 5673:5672 -p 15673:15672 rabbitmq:3-management 
docker run -d --name rabbitmq3 -p 5674:5672 -p 15674:15672 rabbitmq:3-management 
docker run -d --name rabbitmq4 -p 5675:5672 -p 15675:15672 rabbitmq:3-management
```
