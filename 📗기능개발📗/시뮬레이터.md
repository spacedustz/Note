...
docker run -d --name rabbit1 -p 5672:5672 -p 15672:15672 rabbitmq:3-management &&
docker run -d --name rabbit2 -p 5673:5672 -p 15673:15672 rabbitmq:3-management &&
docker run -d --name rabbit3 -p 5674:5672 -p 15674:15672 rabbitmq:3-management &&
docker run -d --name rabbit4 -p 5675:5672 -p 15675:15672 rabbitmq:3-management
```
