...
//        if (event.getInCount() < 0) {  
//            log.info("In Count 값이 음수입니다. 값을 0으로 변경합니다.");  
//            event.setInCount(0);  
//        } else if (event.getInCount() > 15) {  
//            log.info("In Count 값은 15를 초과할 수 없습니다, 값을 15로 변경합니다.");  
//            event.setInCount(15);  
//        }  
//  
//        if (event.getOutCount() < 0) {  
//            log.info("Out Count 값이 음수입니다. 값을 0으로 변경합니다.");  
//            event.setOutCount(0);  
//        } else if (event.getOutCount() > 15) {  
//            log.info("Out Count 값은 15를 초과할 수 없습니다, 값을 15로 변경합니다.");  
//            event.setOutCount(15);  
//        }  
  
        if ((event.getOccupancy() >= 0 && event.getOccupancy() < 15)) {  
            for (String direction : directions) {  
                ...
                if (event.getOccupancy() < 0) {  
                    log.info("재실 인원은 0 이하가 될 수 없습니다. 0으로 초기화 합니다.");  
                    event.setOccupancy(0);  
                }  
  
                if (event.getOccupancy() > 15) {  
                    log.info("재실 인원은 15 이상이 될 수 없습니다. 재실 인원을 15로 설정합니다.");  
                    event.setOccupancy(15);  
                }  
  
                event.setOccupancy(event.getInCount() - event.getOutCount());  
                log.info("재실 인원 : {}", event.getOccupancy());  
                eventRepository.save(event);  
            }  
        }  
    }  
