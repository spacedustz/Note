...
이는 Marker Interface Extension을 구현하는 확장 클래스 자체와 일반적으로 AbstractExtensionId를 상속하는 확장 ID 클래스로 구성됩니다.
...
public class SpringExtension extends AbstractExtensionId<SpringExtension.SpringExt> {
	...
	public static final SpringExtension SPRING_EXTENSION_PROVIDER = new SpringExtention();

	@Override
	public SpringExt createExtension
}
```